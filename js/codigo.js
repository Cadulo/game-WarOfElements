...
class Nation {
  ...
  paintCharacter() {
    canvas.drawImage(this.mapPhoto, this.x, this.y, this.w, this.h);
  }
}

let fireNation = new Nation(
  "Fire nation",
  "fire-nation",
  "img/fire-removebg-preview.png",
  3
);
let waterNation = new Nation(
  "Water nation",
  "water-nation",
  "img/water-removebg-preview.png",
  3
);
let earthNation = new Nation(
  "Earth nation",
  "earth-nation",
  "img/earth-removebg-preview.png",
  3
);
...
function getAttack() {
  fetch(`http://localhost:8080/nation/${enemyId}/attacks`).then(function (res) {
    if (res.ok) {
...
function fight() {
  if (playerAttack[1] == pcAttack[1]) {
    ...
    (playerAttack[1] == "Fire" && pcAttack[1] == "Ice") ||
    (playerAttack[1] == "Water" && pcAttack[1] == "Fire") ||
    (playerAttack[1] == "Earth" && pcAttack[1] == "Fire") ||
    (playerAttack[1] == "Fire" && pcAttack[1] == "Metal") ||
    (playerAttack[1] == "Water" && pcAttack[1] == "Earth") ||
    (playerAttack[1] == "Earth" && pcAttack[1] == "Ice")
  ) {
    createMessage("Win");
    countPcLifes--;
    pcLifes.innerHTML = countPcLifes;
  } else if (
    (playerAttack[1] == "Ice" && pcAttack[1] == "Poison") ||
    (playerAttack[1] == "Earth" && pcAttack[1] == "Air") ||
    (playerAttack[1] == "Poison" && pcAttack[1] == "Earth") ||
    (playerAttack[1] == "Poison" && pcAttack[1] == "Water") ||
    (playerAttack[1] == "Metal" && pcAttack[1] == "Water") ||
    (playerAttack[1] == "Metal" && pcAttack[1] == "Poison")
  ) {
    createMessage("Win");
    countPcLifes--;
    pcLifes.innerHTML = countPcLifes;
  } else if (
    (playerAttack[1] == "Fire" && pcAttack[1] == "Electricity") ||
    (playerAttack[1] == "Poison" && pcAttack[1] == "Fire") ||
    (playerAttack[1] == "Electricity" && pcAttack[1] == "Poison") ||
    (playerAttack[1] == "Water" && pcAttack[1] == "Ice") ||
    (playerAttack[1] == "Air" && pcAttack[1] == "Water") ||
    (playerAttack[1] == "Ice" && pcAttack[1] == "Air") ||
    (playerAttack[1] == "Earth" && pcAttack[1] == "Sand") ||
    (playerAttack[1] == "Metal" && pcAttack[1] == "Earth") ||
    (playerAttack[1] == "Sand" && pcAttack[1] == "Metal") ||
    (playerAttack[1] == "Electricity" && pcAttack[1] == "Water") ||
    (playerAttack[1] == "Air" && pcAttack[1] == "Electricity") ||
    (playerAttack[1] == "Earth" && pcAttack[1] == "Electricity") ||
    (playerAttack[1] == "Electricity" && pcAttack[1] == "Metal") ||
    (playerAttack[1] == "Air" && pcAttack[1] == "Sand") ||
    (playerAttack[1] == "Metal" && pcAttack[1] == "Air") ||
    (playerAttack[1] == "Air" && pcAttack[1] == "Poison") ||
    (playerAttack[1] == "Fire" && pcAttack[1] == "Air") ||
    (playerAttack[1] == "Sand" && pcAttack[1] == "Fire") ||
    (playerAttack[1] == "Poison" && pcAttack[1] == "Sand") ||
    (playerAttack[1] == "Sand" && pcAttack[1] == "Water") ||
    (playerAttack[1] == "Ice" && pcAttack[1] == "Sand")
  ) {
    createMessage("Win");
    countPcLifes--;
    pcLifes.innerHTML = countPcLifes;
  } else if (
    playerAttack[1] == "Shield" ||
    pcAttack[1] == "Shield" ||
    (playerAttack[1] == "Electricity" && pcAttack[1] == "Ice") ||
    (playerAttack[1] == "Sand" && pcAttack[1] == "Electricity") ||
    (playerAttack[1] == "Metal" && pcAttack[1] == "Ice")
  ) {
    createMessage("Tie");
  } else {
    createMessage("Lose");
